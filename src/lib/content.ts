...
export const workItems: WorkItem[] = [
  { title: "Tour merch run", category: "Apparel", method: "4-color screen print", detail: "480 tees", tone: "spot" },
  { title: "Staff uniform drop", category: "Apparel", method: "Discharge print", detail: "120 tees", tone: "paper" },
  { title: "Dad cap program", category: "Headwear", method: "3D puff embroidery", detail: "250 caps", tone: "gold" },
  { title: "Show poster", category: "Posters", method: "Split-fountain flatstock", detail: "100 numbered", tone: "flash" },
  { title: "Launch activation", category: "Events", method: "Live manual press", detail: "6 hours on site", tone: "spot" },
  { title: "Capsule hoodies", category: "Apparel", method: "Puff + relabel", detail: "80 pieces", tone: "gold" },
  { title: "Festival crew kit", category: "Apparel", method: "DTF transfers", detail: "Mixed blanks", tone: "flash" },
  { title: "Gallery print series", category: "Posters", method: "5-color flatstock", detail: "50 signed", tone: "paper" },
